    ...
    for i in range(8):
        for j in range(8):
            if self.matrice[i][j]!=0:
                if self.matrice[i][j].get_couleur()==(self.player+1)%2:
    ...
    for elem in pions_atraiter:
        ...
        for i in range(x-1,x+2):
            for j in range(y-1,y+2):
                if (i>=0  and i<=7) and ( j>=0 and  j<=7) and self.matrice[i][j].get_couleur()==(self.player+1)%2:
        ...
        for pb in encercler:
            ...
            if x==w:
                ...
                if y>z:
                    while k>=0:
                        if self.matrice[w,k]==0:
                            if (w,k) not in list(possibilite.values()):
                                possibilite[elem].append((w,k))
                            break
                        elif self.matrice[w,k].get_couleur()==self.player:
                            break
                        k-=1
            ...
            if y==z:
                ...
                if x>w:
                    k=w
                    while k>=0:
                        if self.matrice[k,z]==0:
                            if (k,z) not in list(possibilite.values()):
                                possibilite[elem].append((k,z))
                            break
                        elif self.matrice[k,z].get_couleur()==self.player:
                            break
                        k-=1
            ...
            if x==w+1 and y==z+1:
                ...
                while k>=0 and k<8 and l>=0 and l<8:
                    if self.matrice[k,l]==0:
                        if (k,l) not in list(possibilite.values()):
                            possibilite[elem].append((k,l))
                            print('A','pos:',(k,l))
                        break
                    elif self.matrice[k,l].get_couleur()==self.player:
                            break
